	  ...
	  //delete from spc_category where id=123
		...
		//TODO
				...
				try {
					...
					String sql="delete from spc_product where id=?";
			...
			request.setAttribute("isDeletedProduct",isDeletedProduct);
			RequestDispatcher rd = request.getRequestDispatcher("delete_product_message.jsp");
