...
Brand oldBrand  = (Brand)request.getAttribute("brand");
 ...
 <table>
    ...
    <td><input type="text" name="brand_id" 
     value ="<%=oldBrand.getId() %>" 
      ...
      <tr>
    <td>Name</td>
    <td><input type="text" name="brand_name"  value ="<%=oldBrand.getName() %>"  style="width:200px;"  required="required"></td>
   </tr>
 
      <tr>
    <td>Details</td>
    <td><textarea  name="brand_details" rows="" cols=""  
    style="width:200px;"  required="required"><%=oldBrand.getDetails() %></textarea> </td>
   </tr>
      <tr>
    <td></td>
    <td  align="right">
